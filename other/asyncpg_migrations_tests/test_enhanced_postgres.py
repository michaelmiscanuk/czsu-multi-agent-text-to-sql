    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(f"✅ Checkpoint listing successful: {len(checkpoints)} checkpoints found")
                
            except Exception as e:
                print(f"⚠️ Checkpoint listing failed (this may be expected for new databases): {e}")
        ...
        try:
            ...
            run_id1 = await create_thread_run_entry(test_email, test_thread_id, "Test prompt 1")
            print(f"✅ Created thread run entry: {run_id1}")
            
            run_id2 = await create_thread_run_entry(test_email, test_thread_id, "Test prompt 2")
        ...
        try:
            ...
            print(f"✅ Concurrent operations: {success_count} successful, {error_count} failed")
        ...
        print("\n" + "🎉" + "="*76 + "🎉")
        print("🎉" + " "*76 + "🎉")
        print("🎉" + " ENHANCED POSTGRESQL CONNECTION SYSTEM TESTS COMPLETED ".center(76) + "🎉")
        print("🎉" + " "*76 + "🎉")
        print("🎉" + "="*76 + "🎉")
