...
async def test_checkpoint_conversation_retrieval():
    ...
    try:
        ...
        messages = await get_conversation_messages_from_checkpoints(checkpointer, test_thread_id)
        ...
        if messages:
            ...
            queries_and_results = await get_queries_and_results_from_latest_checkpoint(checkpointer, test_thread_id)
            ...
            print("This is expected if the thread doesn't exist or has no conversation history")
            ...
            try:
                ...
                print("  Note: To fully test this, you need existing conversation data in checkpoints")
                print("  Consider running the main application first to create test data")
...
async def test_checkpointer_health():
    ...
    try:
        ...
        if hasattr(checkpointer, 'conn'):
            ...
            print("⚠ Checkpointer doesn't have PostgreSQL connection (might be InMemorySaver)")
            return True
