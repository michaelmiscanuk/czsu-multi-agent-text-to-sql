<template>
  <div class="w-full max-w-5xl bg-white flex flex-col rounded-2xl shadow-2xl border border-gray-100 overflow-hidden min-h-[70vh] p-8">
    <div class="flex flex-1 flex-col items-center justify-center text-center p-12">
      <h1 class="text-3xl font-bold mb-4">Welcome to the CZSU Data Explorer and Chatbot</h1>
      ...
      <div class="flex gap-8 mt-8">
        <a
          ...
          class="text-3xl font-bold text-blue-600 hover:text-blue-800 underline"
        >
          API
        </a>
        <a
...
// No logic needed - just display the welcome content
</script> 